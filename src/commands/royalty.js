...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("royalty")
    .setDescription(
      "Calculate the amount of ETH received given you sold a project at a specified price."
    )
    ...
    .addNumberOption((option) =>
      option
        .setName("amount")
        .setDescription("Price sold in ETH.")
        .setRequired(true)
    ),
  ...
  async execute(interaction, args, client) {
    ...
    sdk["retrieving-a-single-collection"]({
      ...
      .then((res) => {
        ...
        let desc = `**If you sold at:** ${amount}Ξ (~$${client
          .convertETH(amount)
          .toLocaleString(
            "en-US"
